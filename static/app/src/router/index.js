...
import DefensiveKeysList from "../views/DefensiveKeysList.vue";
import DefensiveKeysMap from "../views/DefensiveKeysMap.vue";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      { path: "", redirect: "list" },
      { path: "list", component: DefensiveKeysList },
      { path: "map", component: DefensiveKeysMap },
    ],
  },
  {
    path: "/settings",
