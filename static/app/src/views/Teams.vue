    ...
    <div class="container">
      <div class="row">
        <div class="col">
          ...
          <tbody id="teams">
            <tr v-if="!teams.length"><td colspan="6">
            ...
            <tr v-for="team in teams" :key="team.ID">
              ...
              <td>
                <input type=checkbox class="form-check-input" v-model="team.State" true-value="On" false-value="Off" v-on:change="setTeamState(team)"/>
              </td>
              <td>
                <input type=checkbox class="form-check-input" v-model="team.ShareWD" true-value="On" false-value="Off" v-on:change="setTeamShareWD(team)"/>
              </td>
              <td>
                <input type=checkbox class="form-check-input" v-model="team.LoadWD" true-value="On" false-value="Off" v-on:change="setTeamLoadWD(team)"/>
              </td>
              <td>
                <button v-if="isOwner(team)" v-on:click="deleteTeam(team)">Delete</button>
      ...
      <div class="row">
        <div class="col">
          <label>New Team: <input type="text" placeholder="New Team" v-model="newTeamName"></label>
