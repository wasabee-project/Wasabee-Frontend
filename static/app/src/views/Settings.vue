    ...
    <div class="container">
          ...
          <div>
            ...
            <p>
              <em
                ...
                UnverifiedAgent_ name, please ensure your .Rocks and V
        ...
        <div class="card-body">
          <div v-if="me.Telegram" id="telegramContent">
            ...
            <div v-else>
              ...
              >)
              <a
                :href="'https://telegram.me/' + botname + '?start=' + me.lockey"
                >{{ me.lockey }}</a
              >
              to start the verification process. If you have sent this to the
              bot and this step still shows here, log out and back in.
            </div>
          </div>
          <div v-else>
      ...
      <div class="card mb-2">
        ...
        <div class="card-body">
          ...
          <div class="small dim">
            Use this to log into Wasabee-IITC if Google Oauth2 and Webview both
            fail
          </div>
        </div>
      </div>
