          ...
          <div class="content-area">
            <div class="card mb-2">
              ...
              <div class="card-body">
                ...
                <div>
                  ...
                  <p>
                    <em
                      ...
                      <a href="https://enlightened.rocks">.rocks</a>. If you
                      have an UnverifiedAgent_ name, please ensure your .Rocks
                      and V information is correct.</em
                    >
                  </p>
                </div>
                <div>
                ...
                <p>
                  <em
                    >This information is set by the IITC plugin. It should not
                    be trusted for authorization.</em
                  >
                </p>
              </div>
            </div>
            ...
            <div class="card-body">
              <div id="vapidiv">
                <select name="vimportmode" v-model="vimportmode">
                  <option value="team">
                    Create one Wasabee team per V team
                  </option>
                  <option value="role">
